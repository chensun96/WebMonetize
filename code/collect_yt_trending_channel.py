...
def write_content(records_folder, video_ids_list, video_type):
    if video_type == "shorts":
        records_path = os.path.join(records_folder, "shorts_trending_video_ID.csv" )
    elif video_type == "long":
        records_path = os.path.join(records_folder, "long_trending_video_ID.csv" )
    else:
...
if __name__ == "__main__":
    ...
    channel_url = 'https://www.youtube.com/feed/trending?bp=6gQJRkVleHBsb3Jl'
