...
def pipeline(df_features, df_labels, df_records, result_dir):
    ...
    all_negative_domains = perpare_unseen_url_domain(df_negative, num_trials, ads_type, result_dir)
...
if __name__ == "__main__":
    ...
    normal_folder = "../../output/others"
    ads_folder = "../../output/ads"
    affiliate_folder = "../../output/affiliate"
 
    RESULT_DIR = "../../output/results/02_28_uniform_Kfold_CV/"
